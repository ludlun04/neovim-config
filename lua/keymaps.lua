...
vim.keymap.set('n', '\\', function() require('neo-tree.command').execute { toggle = true } end, { silent = true })

vim.keymap.set('n', '<C-\\>', '<Cmd>CopilotChatToggle<CR>', { desc = 'Toggle CopilotChat', silent = true })

vim.keymap.set({ 'n', 'x', 'o' }, '<M-j>', function() require('nvim-treesitter-textobjects.move').goto_next_start('@function.outer', 'textobjects') end)
vim.keymap.set({ 'n', 'x', 'o' }, '<M-k>', function() require('nvim-treesitter-textobjects.move').goto_previous_start('@function.outer', 'textobjects') end)
